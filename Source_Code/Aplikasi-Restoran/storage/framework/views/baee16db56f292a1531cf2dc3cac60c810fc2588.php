...
<div class="col-md-4">
	<div class="panel panel-yellow">
		...
		<div class="panel-body pan">
			<form action="<?php echo e(url('/update_kategori')); ?>" method="POST">
				...
				<div class="form-body pal">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nama_kategori" placeholder="Masukkan Nama Kategori" value="<?php echo e($edit->nama_kategori); ?>">
					</div>
				</div>
...
<?php echo $__env->make("content.layouts", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp-new\htdocs\Tugas-Tantangan-Komputer\Project4\resources\views/content/kategori/update_kategori.blade.php ENDPATH**/ ?>