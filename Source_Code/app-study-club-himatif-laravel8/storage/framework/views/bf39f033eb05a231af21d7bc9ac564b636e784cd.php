...
<head>
	...
	<title><?php echo e($data['title']); ?> | Study Club TI Polindra</title>
			...
			<div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
				<form method="POST" action="/login" onsubmit="return false;" id="form">
					...
					<div>
						...
						<input  class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full" id="email" type="email" name="email" autofocus="autofocus" value="<?php echo e(old('email')); ?>">
					</div>
...
<?php /**PATH D:\Tugas_Pa_Anis\cdaaptnia\It\Done\app-study-club-himatif-laravel8\resources\views/auth/login.blade.php ENDPATH**/ ?>