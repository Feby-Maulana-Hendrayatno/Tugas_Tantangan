<?php echo $__env->make('partials.headerdaftarpenyewa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="header">
                <h4 class="title">Daftar Penyewa</h4>
                  <form action="/daftarpenyewa" method="get">
                        ...
                        <div class="row">
                          <div class="col-md-9">
                            <input name="tanggal" id="datepicker" width="270" value="<?php echo e($tanggal); ?>"/>
                          </div>
                          <div class="col-md-3">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="item<?php echo e($trs->kode_transaksi); ?>">
                                <th scope="row"><?php echo e($loop->iteration); ?></th>
                                <td class="capitalize"><?php echo e($trs->user->nama); ?></td>
                                <td><?php echo e($trs->user->telepon); ?></td>
                                <td><?php echo e($trs->kode_transaksi); ?></td>
                                <td class="capitalize"><?php echo e($trs->operator->nama); ?></td>
                                <td><?php echo e($trs->kode_lapangan); ?></td>
                                <td><?php echo e($trs->kode_jadwal); ?></td>
                                <td><?php echo e($trs->diskon); ?></td>
                                <td><?php echo e($trs->tanggal); ?></td>
                                <td class="horizontal">
                                    <form action="daftarpenyewa/<?php echo e($trs->kode_transaksi); ?>" method="post">
                                        <?php echo method_field('delete'); ?>
                                        <?php echo e(csrf_field()); ?>

                                        <button type="submit" class="btn btn-danger">Hapus</button>
                                        <!-- <a href="daftarpenyewa/<?php echo e($trs->kode_transaksi); ?>/edit" class="btn btn-primary">Edit</a> -->
                                    </form>
                                    <button data-urutan="<?php echo e($loop->iteration); ?>" data-id="<?php echo e($trs->kode_transaksi); ?>" data-operator_nama="<?php echo e($trs->operator->nama); ?>" data-lapangan="<?php echo e($trs->kode_lapangan); ?>" data-user="<?php echo e($trs->kode_user); ?>" data-user_nama="<?php echo e($trs->user->nama); ?>" data-user_kontak="<?php echo e($trs->user->telepon); ?>" data-jadwal="<?php echo e($trs->kode_jadwal); ?>" data-diskon="<?php echo e($trs->diskon); ?>" data-tanggal="<?php echo e($trs->tanggal); ?>" class="btn btn-primary edit-modal">Ubah</button>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.operator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tugas_Pa_Anis\futsal_srikandi\resources\views/daftarpenyewa.blade.php ENDPATH**/ ?>