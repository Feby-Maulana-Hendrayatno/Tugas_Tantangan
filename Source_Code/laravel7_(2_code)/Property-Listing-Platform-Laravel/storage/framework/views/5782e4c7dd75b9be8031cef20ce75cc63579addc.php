    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php endif; ?>
                    <form action="<?php echo e(route('realtors.store')); ?>" method="POST" class="form-horizontal m-t-30" enctype="multipart/form-data"> 
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tugas_Pa_Anis\DONE\laravel7\Property-Listing-Platform-Laravel\resources\views/admin/layouts/realtors/add_realtor.blade.php ENDPATH**/ ?>