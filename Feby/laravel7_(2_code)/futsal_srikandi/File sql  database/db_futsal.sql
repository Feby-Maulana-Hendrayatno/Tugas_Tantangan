...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2022 at 08:50 AM
...
(1, 'Rivaldo', '$2y$10$zsP0FM3mJmFwRF4eALPxk.HCqqyHwP3rk3OSL7zthRNZU78J8jcu2'),
(2, 'Iqbal', '$2y$10$0ufi8aU3/Gb73gucPvuFyel.ufbIrCwedq9eBqFxL9JdkuMJEXE/C'),
(3, 'Jefri', '$2y$10$Kf7ZVGWu390BtXZt2rEJ5eOPA3h6pZaDkdGOMopayRbwE2jovHXTC');
...
(1, 1, 1, 'LA-13', 'A13', 10000, '2020-04-16'),
(2, 1, 2, 'LA-13', 'A13', 10000, '2020-05-03'),
(3, 1, 3, 'LT-13', 'T13', 5000, '2020-05-03'),
(4, 1, 1, 'LA-07', 'A07', 1000, '2020-05-04'),
(5, 1, 2, 'LB-22', 'A22', 3000, '2020-05-04'),
(6, 1, 3, 'LT-15', 'T15', 50000, '2020-05-04');
...
--
ALTER TABLE `transaksi`
  MODIFY `kode_transaksi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `kode_user` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
