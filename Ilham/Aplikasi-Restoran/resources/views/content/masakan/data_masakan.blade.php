...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-plus"></i> Input Data Masakan
			</div>
			<div class="panel-body">
				<form method="POST" action="{{ url('/simpan_data_masakan') }}">
					{{ csrf_field() }}
					<div class="form-group">
						<label class="control-label" for="nama_masakan"> Nama Masakan </label>
						<input type="text" class="form-control" id="nama_masakan" name="nama_masakan" placeholder="Nama Masakan">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" id="stok_masakan" name="stok_masakan" placeholder="0">
					</div>
					<div class="form-group">
