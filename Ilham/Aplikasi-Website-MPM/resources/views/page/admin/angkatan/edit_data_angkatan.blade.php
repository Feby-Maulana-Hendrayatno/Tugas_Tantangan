	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="{{ url('/page/admin/angkatan') }}"> Data Angkatan </a>
				</li>
				<li class="breadcrumb-item active"> Edit Data Angkatan </li>
			</ol>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="{{ url('/page/admin/angkatan/simpan') }}">
				{{ csrf_field() }}
				<input type="hidden" name="id_angkatan" value="{{ $edit->id_angkatan }}">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<i class="fa fa-edit"></i> Edit Data Angkatan
						</h3>
					</div>
					<div class="card-body">
						<div class="form-group">
							<label for="tahun_angkatan"> Tahun Angkatan </label>
							<input type="year" class="form-control" id="tahun_angkatan" name="tahun_angkatan" placeholder="Masukkan Tahun Angkatan" value="{{ $edit->tahun_angkatan }}">
						</div>
					</div>
