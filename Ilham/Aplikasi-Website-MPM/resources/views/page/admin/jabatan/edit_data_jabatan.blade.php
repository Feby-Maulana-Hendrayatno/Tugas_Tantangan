	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="{{ url('/page/admin/jabatan/') }}"> Data Jabatan </a>
				</li>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="{{ url('/page/admin/jabatan/simpan') }}">
				{{ csrf_field() }}
				<input type="hidden" name="id_jabatan" value="{{ $edit->id_jabatan }}">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" placeholder="Masukkan Nama Jabatan" value="{{ $edit->nama_jabatan }}">
						</div>
					</div>
