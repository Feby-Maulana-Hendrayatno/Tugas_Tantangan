...
@section("page_header") <i class="fa fa-money"></i> Bayar Tagihan Pengguna @stop
...
<ol class="breadcrumb">
	...
	<li class="active">Bayar Tagihan Penggunaan</li>
</ol>
		...
		<div class="box box-info">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" value="Rp. {{ number_format($detail->jumlah_bayar) }}" readonly style="background-color: white;">
				</div>
				<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" value="{{ $detail->lpb_penggunaan->id_penggunaan }}" readonly style="background-color: white;">
						</div>						
					</div>
					<div class="col-md-6">
						<div class="form-group">
	...
	<div class="col-md-12">
		<div class="box box-info">
			...
			<form method="POST" action="{{ url('/pembayaran') }}">
				{{ csrf_field() }}
				<input type="hidden" name="id_pelanggan" value="{{ $detail->lpb_pelanggan->id_pelanggan }}">
