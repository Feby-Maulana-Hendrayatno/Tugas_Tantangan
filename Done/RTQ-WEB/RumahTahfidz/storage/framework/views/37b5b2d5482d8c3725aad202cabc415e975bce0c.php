...
<?php $__env->startSection("app_title", "Data Siswa"); ?>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $data_santri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo e($santri->no_hp); ?></td>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('app/sistem/siswa')); ?>" method="post" id="tambahSiswa" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalExcel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('app/sistem/siswa/import')); ?>" method="post" id="tambahSiswa" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("body").on('click', '#btnEdit', function() {
            let id = $(this).data('id');
            $.get('<?php echo e(url("app/admin/siswa/")); ?>/' + id, function (response) {
                ...
                //         Swal.fire({
                    ...
                    //     } else {
                        //         $.ajax({
                            //             url : "<?php echo e(url('/api/siswa')); ?>",
                            //             type : "POST",
                            //             data : { nama : nama, jenis_kelamin : jenis_kelamin, alamat : alamat, nama_ayah : nama_ayah, nama_ibu : nama_ibu, no_hp : no_hp, tempat_lahir : tempat_lahir, tanggal_lahir : tanggal_lahir ,_token: "<?php echo e(csrf_token()); ?>" },
                            //             success : function(response) {
                                                ...
                                                // $("#btn-edit").on('click', function() {
                                                    ...
                                                    //     if (nama == "" || jenis_kelamin == "" || alamat == "" || nama_ayah == "" || nama_ibu == "" || no_hp == "" || tempat_lahir == "" || tanggal_lahir == "") {
                                                        //         Swal.fire({
                                                            ...
                                                            //     } else {
                                                                //         $.ajax({
                                                                    //             url : "<?php echo e(url('/api/siswa/')); ?>/" + id,
                                                                    //             type : "POST",
                                                                    //             data : { id : id, nama : nama, jenis_kelamin : jenis_kelamin, alamat : alamat, nama_ayah : nama_ayah, nama_ibu : nama_ibu, no_hp : no_hp, oldNoHp : oldNoHp , tempat_lahir : tempat_lahir, tanggal_lahir : tanggal_lahir , _token: "<?php echo e(csrf_token()); ?>", _method : "PUT" },
                                                                    //             success : function(response) {
...
<?php echo $__env->make(".app.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/siswa/v_index.blade.php ENDPATH**/ ?>