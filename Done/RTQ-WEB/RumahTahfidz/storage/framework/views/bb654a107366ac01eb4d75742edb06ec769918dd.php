...
<script type="text/javascript">
    ...
    function tampilData() {
        ...
        empTable.innerHTML = "";
        $.ajax({
            url: "<?php echo e(url('')); ?>/api/status_absen",
            type: "GET",
    ...
    $(document).ready(function() {
        ...
        $("#btn-edit").on('click', function() {
            ...
            if (keterangan == "") {
                ...
                $.ajax({
                    url : "<?php echo e(url('/api/status_absen/')); ?>/" + id,
                    type : "POST",
...
<?php echo $__env->make(".app.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/status_absen/v_index.blade.php ENDPATH**/ ?>