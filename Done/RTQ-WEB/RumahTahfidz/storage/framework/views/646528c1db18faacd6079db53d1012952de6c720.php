...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="pendidikan_terakhir" id="pendidikan_terakhir" placeholder="Masukkan Pendidikan Terakhir" value="<?php echo e($edit->pendidikan_terakhir); ?>">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
...
<?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/super_admin/admin_cabang/v_edit.blade.php ENDPATH**/ ?>