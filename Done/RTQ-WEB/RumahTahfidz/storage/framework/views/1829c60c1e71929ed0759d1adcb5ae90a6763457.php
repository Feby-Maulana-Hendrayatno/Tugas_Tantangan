...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("body").on('click', '#btnEdit', function() {
            ...
            $.get('<?php echo e(url("api/cabang/")); ?>/' + id, function (response) {
                $("#id").val(id)
        ...
        $("#btn-tambah").on('click', function() {
            ...
            if (nama_cabang == "") {
                ...
                $.ajax({
                    url : "<?php echo e(url('/api/cabang')); ?>",
                    type : "POST",
                    data : { nama_cabang : nama_cabang, _token: "<?php echo e(csrf_token()); ?>" },
                    success : function(response) {
        ...
        $("#btn-edit").on('click', function() {
            ...
            if (nm_cabang == "") {
                ...
                $.ajax({
                    url : "<?php echo e(url('/api/cabang/')); ?>/" + id,
                    type : "POST",
                    data : { id : id, nama_cabang : nm_cabang, _token: "<?php echo e(csrf_token()); ?>", _method : "PUT" },
                    success : function(response) {
...
<?php echo $__env->make("app.administrator.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/cabang/v_index.blade.php ENDPATH**/ ?>