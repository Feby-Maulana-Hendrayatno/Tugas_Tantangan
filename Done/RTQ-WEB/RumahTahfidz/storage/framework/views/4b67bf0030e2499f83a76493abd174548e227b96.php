                        ...
                        <table class="table table-bordered table-hover" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($santri->getUser->nama); ?></td>
                                    <td><?php echo e($santri->getUser->email); ?></td>
                                    <td class="text-center"><?php echo e($santri->getUser->no_hp); ?></td>
                                    <td class="text-center">
                                        <?php if($santri->getUser->jenis_kelamin == "L"): ?>
                                        Laki - Laki
                                        <?php elseif($santri->getUser->jenis_kelamin == "P"): ?>
                                        Perempuan
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        <button onclick="editDataSantri(<?php echo e($santri->id); ?>)" type="button" class="btn btn-warning" id="btnEdit" data-target="#modalEdit" data-toggle="modal">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <form action="<?php echo e(url('/app/sistem/santri/'.$santri->id)); ?>" method="POST" style="display: inline">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('app/sistem/santri')); ?>" method="post" id="tambahSiswa" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('/app/sistem/santri/simpan')); ?>" method="POST">
...
<script>
    ...
    {
        $.ajax({
            url : "<?php echo e(url('/app/sistem/santri/edit')); ?>",
            type : "GET",
            data : { id : id },
...
<?php echo $__env->make(".app.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/santri/v_index.blade.php ENDPATH**/ ?>