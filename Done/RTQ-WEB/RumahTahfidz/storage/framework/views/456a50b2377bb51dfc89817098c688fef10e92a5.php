    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo e(Request::segment(3) == "home" ? "active" : ""); ?>">
                <a href="<?php echo e(url('/app/admin/home')); ?>" class="nav-link">
            ...
            <li class="<?php echo e(Request::segment(3) == "siswa" ? "active" : ""); ?>">
                <a class="nav-link" href="<?php echo e(url('/app/sistem/siswa')); ?>">
                    <i class="fa fa-user"></i>
                    <span>Siswa</span>
                </a>
            </li>
            <li class="<?php echo e(Request::segment(3) == "pengajar" ? "active" : ""); ?>">
                <a class="nav-link" href="<?php echo e(url('/app/sistem/pengajar')); ?>">
                    <i class="fa fa-user"></i>
                    <span>Pengajar</span>
                </a>
            </li>
            ...
            <li class="<?php echo e(Request::segment(3)=='penilaian' ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('/app/sistem/penilaian')); ?>">
                    <i class="fa fa-book"></i>
                    <span>Penilaian</span>
                </a>
            </li>
            ...
            <li class="<?php echo e(Request::segment(3) == "profil" ? "active" : ""); ?>">
                <a class="nav-link" href="<?php echo e(url('/app/admin/profil')); ?>">
            ...
            <li class="<?php echo e(Request::segment(3)=='profile' ? 'active' : ''); ?>">
...
<?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/layouts/partials/sidebar/main-sidebar.blade.php ENDPATH**/ ?>