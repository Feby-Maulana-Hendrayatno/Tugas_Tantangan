<?php $__env->startSection("app_title", "Data Asatidz"); ?>
                        ...
                        <table class="table table-bordered table-hover" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($asatidz->getUser->nama); ?></td>
                                    <td><?php echo e($asatidz->getUser->email); ?></td>
                                    <td class="text-center"><?php echo e($asatidz->getUser->no_hp); ?></td>
                                    <td class="text-center">
                                        <?php if($asatidz->getUser->jenis_kelamin == "L"): ?>
                                            Laki - Laki
                                        <?php elseif($asatidz->getUser->jenis_kelamin == "P"): ?>
                                            Perempuan
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <form action="<?php echo e(url('/app/sistem/asatidz/'.$asatidz->id)); ?>" method="POST" style="display: inline;">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('/app/sistem/asatidz')); ?>" method="post" id="tambahPengajar" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('/app/sistem/asatidz/simpan')); ?>" method="post" enctype="multipart/form-data" id="editPengajar">
...
<script>
    ...
    {
        $.ajax({
            url : "<?php echo e(url('/app/sistem/asatidz/edit')); ?>",
            type : "GET",
            data : { id : id },
...
<?php echo $__env->make(".app.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\FILE KULIAH\SEMESTER 4\TUGAS KULIAH TAHUN AJARAN 2021 - 2022\PROYEK 3\RTQ-WEB\RumahTahfidz\resources\views/app/administrator/asatidz/v_index.blade.php ENDPATH**/ ?>