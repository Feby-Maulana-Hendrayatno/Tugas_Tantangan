<?php $__env->startSection('title', 'Biodata Penduduk'); ?>
...
<section class="content">
    ...
    <?php endif; ?>
    <form action="<?php echo e(url('/page/admin/kependudukan/penduduk/'.$data_penduduk->id.'/edit')); ?>" method="POST" enctype="multipart/form-data" id="formTambahPendudukLahir">
            ...
            <div class="col-md-8">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo e(url('/page/admin/kependudukan/penduduk/')); ?>" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Data Penduduk">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm date">
                                        ...
                                        <input class="form-control input-sm pull-right" id="tgl_6" name="tgl_lapor" type="text" value="<?php echo e($data_penduduk->created_at->formatLocalized("%Y-%m-%d")); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" id="nik" class="form-control input-sm" placeholder="Masukkan NIK" value="<?php echo e($data_penduduk->nik); ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="nama"> Nama Lengkap </label>
                                    <input type="text" name="nama" id="nama" class="form-control input-sm" placeholder="Masukkan Nama Lengkap" value="<?php echo e($data_penduduk->nama); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" name="kk_sebelumnya" id="kk_sebelumnya" placeholder="No. KK Sebelumnya" value="<?php echo e($data_penduduk->kk_sebelumnya); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="id_sex" id="id_sex" class="form-control input-sm">
                                        ...
                                        <option value="<?php echo e($sex->id); ?>" <?php echo e(($data_penduduk->id_sex == $sex->id) ? 'selected' : ''); ?> >
                                            <?php echo e($sex->nama); ?>
                            ...
                            <div class="col-sm-7">
                                ...
                                <select name="id_agama" id="id_agama" class="form-control input-sm select2">
                                    ...
                                    <option value="<?php echo e($agama->id); ?>" <?php echo e(($data_penduduk->id_agama == $agama->id) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="akta_lahir" id="akta_lahir" class="form-control input-sm" placeholder="Masukkan Akta Lahir" value="<?php echo e($data_penduduk->akta_lahir); ?>">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="tempat_lahir"> Tempat Lahir </label>
                                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control input-sm" placeholder="Masukkan Tempat Lahir" value="<?php echo e($data_penduduk->tempat_lahir); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm date">
                                        ...
                                        <input class="form-control input-sm pull-right datepicker" name="tgl_lahir" id="tgl_lahir" type="text" value="<?php echo e($data_penduduk->tgl_lahir); ?>" placeholder="Tanggal Lahir">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm date">
                                        ...
                                        <input class="form-control input-sm pull-right timepicker" id="waktu_lahir" name="waktu_lahir" type="text" value="<?php echo e($data_penduduk->waktu_lahir); ?>" placeholder="Waktu Lahir">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_pendidikan" id="id_pendidikan" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($pendidikan_kk->id); ?>" <?php echo e(($data_penduduk->id_pendidikan == $pendidikan_kk->id ) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_pendidikan_sedang" id="id_pendidikan_sedang" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($pendidikan->id); ?>" <?php echo e(($data_penduduk->id_pendidikan_sedang == $pendidikan->id) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_pekerjaan" id="id_pekerjaan" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($pekerjaan->id); ?>" <?php echo e(($data_penduduk->id_pekerjaan == $pekerjaan->id) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="id_warga_negara" id="id_warga_negara" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($warganegara->id); ?>" <?php echo e(($data_penduduk->id_warga_negara == $warganegara->id) ? 'selected' : ''); ?> >
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik_ayah" id="nik_ayah" class="form-control input-sm" placeholder="NIK Ayah" value="<?php echo e($data_penduduk->nik_ayah); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="nama_ayah"> Nama Ayah </label>
                                    <input type="text" name="nama_ayah" id="nama_ayah" class="form-control input-sm" placeholder="Nama ayah" value="<?php echo e($data_penduduk->nama_ayah); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik_ibu" id="nik_ibu" class="form-control input-sm" placeholder="NIK Ibu" value="<?php echo e($data_penduduk->nik_ibu); ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="nama_ibu"> Nama Ibu </label>
                                    <input type="text" name="nama_ibu" id="nama_ibu" class="form-control input-sm" placeholder="Nama Ibu" value="<?php echo e($data_penduduk->nama_ibu); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat_sekarang" id="alamat_sekarang" class="form-control input-sm" value="<?php echo e($data_penduduk->alamat_sekarang); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_dusun" id="id_dusun" class="form-control input-sm select2" width="100%">
                                        ...
                                        <option value="<?php echo e($d->id); ?>" <?php echo e($data_penduduk->id_dusun == $d->id ? 'selected' : ''); ?>>
                                            <?php echo e($d->dusun); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group" id="rwSebelumnya">
                                    ...
                                    <select id="" name="" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($rw->id); ?>" <?php echo e($rw->id == $data_penduduk->id_rw ? 'selected' : ''); ?>><?php echo e($rw->rw); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group" id="rtSebelumnya">
                                    ...
                                    <select name="" id="" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($rt->id); ?>" <?php echo e($rt->id == $data_penduduk->id_rt ? 'selected' : ''); ?>><?php echo e($rt->rt); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telepon" id="telepon" class="form-control input-sm"  value="<?php echo e($data_penduduk->telepon); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control input-sm"  value="<?php echo e($data_penduduk->email); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat_sebelumnya" id="alamat_sebelumnya" class="form-control input-sm"  value="<?php echo e($data_penduduk->alamat_sebelumnya); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="" id="" class="form-control input-sm">
                                        ...
                                        <option value="<?php echo e($kawin->id); ?>" <?php echo e($kawin->id == $data_penduduk->status_kawin ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="akta_perkawinan" id="akta_perkawinan" class="form-control input-sm" value="<?php echo e($data_penduduk->akta_perkawinan); ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm date">
                                        ...
                                        <input class="form-control input-sm pull-right datepicker" name="tanggal_perkawinan" id="tanggal_perkawinan" type="text" value="<?php echo e($data_penduduk->tanggal_perkawinan); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="akta_perceraian" id="akta_perceraian" class="form-control input-sm" value="<?php echo e($data_penduduk->akta_perceraian); ?>">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm date">
                                        ...
                                        <input class="form-control input-sm pull-right datepicker" name="tanggal_perceraian" id="tanggal_perceraian" type="text" value="<?php echo e($data_penduduk->tanggal_perkawinan); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_golongan_darah" id="id_golongan_darah" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($darah->id); ?>" <?php echo e(($data_penduduk->id_golongan_darah == $darah->id) ? 'selected' : ''); ?> >
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_cacat" id="id_cacat" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($cacat->id); ?>" <?php echo e($cacat->id == $data_penduduk->id_cacat ? 'selected' : ''); ?>>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_sakit_menahun" id="id_sakit_menahun" class="form-control input-sm select2">
                                        ...
                                        <option value="<?php echo e($sakit_menahun->id); ?>" <?php echo e($sakit_menahun->id == $data_penduduk->id_sakit_menahun ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/penduduk/edit.blade.php ENDPATH**/ ?>