                            ...
                            <div class="col-sm-8">
                                <select name="id_pegawai" id="id_pegawai" class="form-control input-sm select2" width="100%">
                                    ...
                                    <option value="<?php echo e($pegawai->id); ?>">
                                        NIP : <?php echo e($pegawai->nip . ' - ' . $pegawai->nama); ?> (<?php echo e($jabatan->getJabatan->nama_jabatan); ?>)
                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/template-surat/surat-keterangan-domisili.blade.php ENDPATH**/ ?>