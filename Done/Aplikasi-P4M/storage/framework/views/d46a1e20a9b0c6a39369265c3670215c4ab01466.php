    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box">
                ...
                <form action="<?php echo e(url('/page/admin/tahun/'.$edit->id)); ?>" method="POST">
                    <?php echo method_field("PUT"); ?>
                    <?php echo csrf_field(); ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="tahun"> Tahun </label>
                            <input type="year" class="form-control" name="tahun" id="tahun" placeholder="0" value="<?php echo e($edit->tahun); ?>">
                        </div>
                    </div>
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(url('/page/admin/tahun')); ?>" class="btn btn-info btn-sm pull-right">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/tahun/edit.blade.php ENDPATH**/ ?>