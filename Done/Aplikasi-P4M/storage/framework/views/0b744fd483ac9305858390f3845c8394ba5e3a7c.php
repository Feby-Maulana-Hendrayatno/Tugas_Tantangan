        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <?php if($detail->tanggal_berakhir > now()): ?>
                    <a href="<?php echo e(url('/page/admin/program_bantuan/'.$detail->id.'/tambah_peserta')); ?>" class="btn btn-social btn-primary btn-flat btn-sm" title="Tambah Peserta Baru">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/program_bantuan/rincian_bantuan_peserta.blade.php ENDPATH**/ ?>