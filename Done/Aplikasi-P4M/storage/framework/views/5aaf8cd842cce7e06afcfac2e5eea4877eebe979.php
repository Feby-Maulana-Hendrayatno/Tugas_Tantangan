...
<section class="content">
    <form action="<?php echo e(url('/page/admin/kependudukan/penduduk/simpan_data_penduduk_masuk/')); ?>" method="POST" enctype="multipart/form-data" id="formTambahPendudukLahir">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/penduduk/tambah_penduduk_lahir.blade.php ENDPATH**/ ?>