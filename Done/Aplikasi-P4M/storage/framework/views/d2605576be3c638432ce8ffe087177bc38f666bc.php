            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $p->getCountPenduduk->count(); ?> Orang</td>
                        <td class="text-center">
                            <?php if($p->getCountPenduduk->count() == 0): ?>
                            0
                            <?php else: ?>
                            <?php echo round($p->getCountPenduduk->count() / $penduduk * 100, 2); ?>
...
<?php echo $__env->make('pengunjung/layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/pengunjung/page/data_desa/pekerjaan.blade.php ENDPATH**/ ?>