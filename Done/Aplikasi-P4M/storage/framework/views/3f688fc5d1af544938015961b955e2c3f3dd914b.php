...
<div class="form-group">
    ...
    <div class="box-profile">
        <?php if($edit->gambar): ?>
        <img src="<?php echo e(url('/storage/'.$edit->gambar)); ?>" class="gambar-preview penduduk profile-user-img img-responsive" style="border-radius: 50%; width: 200px; height: 200px; margin-bottom: 15px" src="<?php echo e(url('/gambar/upload.png')); ?>" alt="Foto Penduduk">
        <?php else: ?>
...
<?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/web/galeri/edit.blade.php ENDPATH**/ ?>