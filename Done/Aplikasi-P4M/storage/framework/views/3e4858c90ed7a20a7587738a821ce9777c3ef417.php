...
<script>
    ...
    $(document).ready(function() {
        $("#kategoriTable").dataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(url('/page/admin/kategori/showall')); ?>",
            columnDefs: [
        ...
        $("body").on('click', "#tambahKategori", function() {
            ...
            if (nama == "") {
                ...
                $.ajax({
                    url: "<?php echo e(url('/page/admin/kategori')); ?>",
                    type: "POST",
                    data: {
                        nama: nama,
                        slug: slug,
        ...
        $("body").on('click', "#hapusKategori", function() {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "<?php echo e(url('/page/admin/kategori')); ?>/"+id,
                        type: "post",
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/web/kategori/index.blade.php ENDPATH**/ ?>