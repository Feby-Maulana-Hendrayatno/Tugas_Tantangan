...
<?php $__env->startSection('title', 'Tambah Data Format Surat'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <form action="<?php echo e(url('/page/admin/surat/format')); ?>" method="POST" class="form-horizontal" id="formTambahFormat">
                    <?php echo csrf_field(); ?>
                    <div class="box-body">
                ...
                <div class="box-body">
                    <div class="callout callout-danger">
                        ...
                        <p>
                            ...
                            <a href="<?php echo e(url('/page/admin/surat/ref_syarat')); ?>"> Silahkan Inputkan Data Referensi Syarat Surat Terlebih Dahulu</a>
                        </p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/surat/format/form_tambah_data_surat_format.blade.php ENDPATH**/ ?>