<?php $__env->startSection('title', 'Data Sarana Pendidikan'); ?>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <a href="<?php echo e(url('/sarpras/pendidikan')); ?>" target="_blank" class="btn btn-social btn-info btn-flat btn-sm" style="margin-left: 5px" title="Lihat">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning btn-sm" onclick="editSaranaPendidikan(<?php echo e($p->id); ?>)" data-toggle="modal" data-target="#editSaranaPendidikan" title="Ubah Data">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <form action="<?php echo e(url('page/admin/sarana/pendidikan/'.$p->id)); ?>" method="POST" style="display: inline">
...
<div class="modal fade" id="tambahSaranaPendidikan">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('page/admin/sarana/pendidikan')); ?>" method="POST" id="formTambahSarana">
...
<div class="modal fade" id="editSaranaPendidikan">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('page/admin/sarana/pendidikan')); ?>" method="POST" id="formEditSarana">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/sarana/pendidikan/index.blade.php ENDPATH**/ ?>