...
<section class="content">
    <form action="<?php echo e(url('/page/admin/kependudukan/keluarga/tambah_data_anggota_keluarga_masuk/')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a href="<?php echo e(url('/page/admin/kependudukan/keluarga/'.$edit->id)); ?>/rincian_keluarga" class="btn btn-social btn-flat btn-sm btn-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" id="nik" class="form-control input-sm" placeholder="Masukkan NIK" value="<?php echo e($edit->no_kk); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="nama"> Kepala KK </label>
                                    <input type="text" name="nama" id="nama" class="form-control input-sm" placeholder="Masukkan Nama" value="<?php echo e($edit->getDataPenduduk->nama); ?>" readonly>
                                </div>
                            </div>
