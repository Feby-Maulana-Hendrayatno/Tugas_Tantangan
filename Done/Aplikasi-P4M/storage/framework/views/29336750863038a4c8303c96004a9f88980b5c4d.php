<?php $__env->startSection('title', 'Biodata Anggota Keluarga'); ?>
...
<section class="content">
    <form action="<?php echo e(url('/page/admin/kependudukan/keluarga/tambah_data_anggota_keluarga_lahir/')); ?>" method="POST" enctype="multipart/form-data" id="formTambahPendudukLahir">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id" value="<?php echo e($edit->getDataPenduduk->id); ?>">
        <div class="row">

            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="penduduk profile-user-img img-responsive gambar-preview" style="border-radius: 35px; width: 200px; height: 200px; margin-bottom: 15px" src="<?php echo e(url('/gambar/gambar_kepala_user.png')); ?>" alt="Foto Penduduk">
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <a href="<?php echo e(url('/page/admin/kependudukan/keluarga/')); ?>" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali ke Daftar Keluarga">
                            <i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Keluarga
                        </a>
                        <a href="<?php echo e(url('/page/admin/kependudukan/keluarga/'.$edit->id)); ?>/rincian_keluarga" class="btn btn-social btn-flat btn-sm btn-info" title="Kembali ke Daftar Anggota Keluarga">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" placeholder="Masukkan NIK" value="<?php echo e($edit->no_kk); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="kk_"> Kepala KK </label>
                                    <input type="text" class="form-control input-sm" placeholder="Masukkan Nama" value="<?php echo e($edit->getDataPenduduk->nama); ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nik" id="nik" class="form-control input-sm" placeholder="Masukkan NIK" value="<?php echo e($edit->getDataPenduduk->nik); ?>">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="nama"> Nama </label>
                                    <input type="text" name="nama" id="nama" class="form-control input-sm" placeholder="Masukkan Nama Lengkap" value="<?php echo e($edit->getDataPenduduk->nama); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/kependudukan/keluarga/tambah_anggota_keluarga_lahir.blade.php ENDPATH**/ ?>