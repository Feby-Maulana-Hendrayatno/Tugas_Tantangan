...
<div class="content">
  <form id="tambahBerita" action="<?php echo e(url('/page/admin/berita/'.$edit->slug)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="box">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?php if($edit->image): ?>
              <img class="gambar-preview" src="<?php echo e(url('/storage/'.$edit->image)); ?>" style="width: 300px">
              <?php else: ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/berita/form_edit.blade.php ENDPATH**/ ?>