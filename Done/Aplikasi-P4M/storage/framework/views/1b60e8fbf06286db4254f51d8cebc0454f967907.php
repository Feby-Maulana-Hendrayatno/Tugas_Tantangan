<?php $__env->startSection('title', 'Form Tambah Surat Masuk'); ?>
...
<?php if($data_klasifikasi->count()): ?>
    <?php if($data_struktur->count()): ?>
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo e(url('/page/admin/surat/keluar')); ?>" class="btn btn-social btn-flat btn-info btn-flat btn-sm" title="Kembali ke Daftar Surat Masuk">
                            <i class="fa fa-arrow-circle-left"></i> Kembali ke Daftar Surat Masuk
                        </a>
                    </div>
                    <form action="<?php echo e(url('/page/admin/surat/masuk')); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="box-body">
                            <div class="form-group">
                                <label for="nomor_urut" class="col-sm-3"> Nomor Urut </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nomor_urut" id="nomor_urut" placeholder="Masukkan Nomor Urut" value="<?php echo e($data); ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right datepicker" name="tanggal_penerimaan" value="<?php echo e(old('tanggal_penerimaan')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box-body">
                        <div class="callout callout-danger">
                            ...
                            <p>
                                ...
                                <a href="<?php echo e(url('/page/admin/pemerintahan/struktur_pemerintahan')); ?>">Silahkan Inputkan Data Struktur Pemerintahan Terlebih Dahulu</a>
                            </p>
                          </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/surat/masuk/form_tambah.blade.php ENDPATH**/ ?>