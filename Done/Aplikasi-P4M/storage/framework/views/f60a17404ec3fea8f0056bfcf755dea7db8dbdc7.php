<?php $__env->startSection('title', "Data Peta Desa"); ?>
...
<section class="content">
    <div class="box box-info">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    <form action="<?php echo e(url('/page/admin/peta/desa')); ?>" method="post" id="formPeta">
                        <?php if($desa): ?>
                        <?php echo method_field("put"); ?>
                        <input type="hidden" name="id" id="id" value="<?php echo e($desa->id); ?>">
                        <?php endif; ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            ...
                            <?php else: ?>
                            <textarea name="url" id="url" rows="8" class="form-control" placeholder="Silahkan Masukkan URL"><?php echo $desa->wilayah_desa; ?></textarea>
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                            <?php if(empty($desa)): ?>
                ...
                <div class="col-md-6">
                    ...
                    <img src="<?php echo e(url('/frontend/img/step-maps.png')); ?>" width="100%" height="">
                </div>
            </div>
        </div>
    </div>
    <div class="box box-info">
        ...
        <div class="box-body">
            <?php if(empty($desa) || $desa->wilayah_desa == NULL): ?>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/peta/desa.blade.php ENDPATH**/ ?>