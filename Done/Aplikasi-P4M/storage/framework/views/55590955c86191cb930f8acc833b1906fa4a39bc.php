                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(url('arsip/'.$data->getPenduduk->nama.' - '.$data->getPenduduk->nik.'.docx')); ?>" target="_blank" class="btn btn-sm bg-purple"><i class="fa fa-file-word-o"></i></a>
                                    ...
                                    <?php if(empty($data->getPegawai->getPenduduk->nama)): ?>
                                    <td><?php echo e($data->getPegawai->nama); ?></td>
                                    <?php else: ?>
                                    <td><?php echo e($data->getPegawai->getPenduduk->nama); ?></td>
                                    <?php endif; ?>
