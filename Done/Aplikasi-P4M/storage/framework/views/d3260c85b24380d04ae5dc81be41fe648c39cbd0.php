    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box">
                ...
                <form action="<?php echo e(url('/page/admin/staf')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="box-body">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/staf/index.blade.php ENDPATH**/ ?>