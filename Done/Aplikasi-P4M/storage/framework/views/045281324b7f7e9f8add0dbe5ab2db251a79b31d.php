                ...
                <form action="<?php echo e(url('/page/admin/kategori')); ?>/<?php echo e($edit->slug); ?>" method="POST" id="editKategori">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Kategori" value="<?php echo e($edit->nama); ?>">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo e(url('/page/admin/kategori')); ?>" class="btn btn-danger btn-sm">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views//admin/page/kategori/edit.blade.php ENDPATH**/ ?>