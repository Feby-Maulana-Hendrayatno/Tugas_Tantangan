<?php $__env->startSection('title', 'Data Rumah Tangga'); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="<?php echo e(url('/page/admin/kependudukan/rtm/'.$data->id)); ?>" method="POST" style="display: inline;">
                ...
                <div class="box-body">
                    <div class="callout callout-danger">
                        ...
                        <p>
                            ...
                            <a href="<?php echo e(url('/page/admin/kependudukan/keluarga')); ?>">Silahkan Inputkan Data Keluarga Terlebih Dahulu</a>
                        </p>
                      </div>
                </div>
            </div>
...
<div class="modal fade" id="modalBox">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('/page/admin/kependudukan/rtm/')); ?>" method="POST" id="formTambahRTM">
                <?php echo csrf_field(); ?>
