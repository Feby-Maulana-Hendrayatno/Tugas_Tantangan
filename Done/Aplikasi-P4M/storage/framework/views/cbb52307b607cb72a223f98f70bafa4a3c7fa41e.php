    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box">
                ...
                <form id="editStruktur" action="<?php echo e(url('/page/admin/struktur_pemerintahan/'.$edit->id)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="staf_id" id="staf_id" class="form-control select2" style="width: 100%">
                                ...
                                <?php $__currentLoopData = $data_staf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($edit->staf_id == $staf->id): ?>
                                        <option value="<?php echo e($staf->id); ?>" selected>
                                            <?php echo e($staf->staf); ?>

                                        </option>
                                    <?php else: ?>
                                        <option value="<?php echo e($staf->id); ?>">
                                            <?php echo e($staf->staf); ?>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo e(url('/page/admin/struktur_pemerintahan')); ?>" class="pull-right btn btn-info btn-sm">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Project-P4M\P4M\resources\views/admin/page/struktur_pemerintahan/edit.blade.php ENDPATH**/ ?>