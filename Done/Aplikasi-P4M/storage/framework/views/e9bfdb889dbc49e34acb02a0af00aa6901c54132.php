...
<section class="content-header">
  <h1>
    Edit <?php echo $__env->yieldContent('title'); ?>
  </h1>
  <ol class="breadcrumb">
    <li>
...
<div class="content">
  <form id="editArtikel" action="<?php echo e(url('/page/admin/web/artikel/'.$edit->slug)); ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="col-md-8">
        <div class="box box-info">
            <div class="box-header">
                <a href="<?php echo e(url('page/admin/web/artikel')); ?>" class="btn btn-social btn-info btn-flat btn-sm">
