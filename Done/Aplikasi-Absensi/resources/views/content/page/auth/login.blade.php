...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ url('/layout') }}/plugins/iCheck/square/blue.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="../../index2.html"><b>{{ config("app.myapp") }}</b></a>
            </div>
            <!-- /.login-logo -->
        ...
        <!-- iCheck -->
        <script src="{{ url('/layout') }}/plugins/iCheck/icheck.min.js"></script>
        <script>
            $(function () {
                $('input').iCheck({
