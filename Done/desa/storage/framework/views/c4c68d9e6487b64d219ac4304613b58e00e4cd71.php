...
<head>
    ...
    <!-- Page plugins -->
    <!-- Argon CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('/admin')); ?>/assets/css/argon.css?v=1.2.0" type="text/css">
</head>
...
<body>
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/skd')); ?>">
                                <i class="ni ni-email-83"></i>
                                <span class="nav-link-text">Surat Masuk SKD</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/sku')); ?>">
                                <i class="ni ni-email-83"></i>
                                <span class="nav-link-text">Surat Masuk SKU</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/sktm')); ?>">
                                <i class="ni ni-email-83"></i>
                                <span class="nav-link-text">Surat Masuk SKTM</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/penduduk')); ?>">
                                <i class="ni ni-single-02 text-yellow"></i>
                                <span class="nav-link-text">Data Kependudukan</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/akun')); ?>">
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="<?php echo e(asset('/admin')); ?>/assets/img/theme/team-4 1.jpg">
                                    </span>
    ...
    <!-- Argon JS -->
    <script src="<?php echo e(asset('/admin')); ?>/assets/js/argon.js?v=1.2.0"></script>
    <script>
        $(function() {
            $.ajaxSetup({
                headers: {
...
<?php /**PATH D:\Tugas_Pa_Anis\Proyek-2\Proyek-2\resources\views/template/layout.blade.php ENDPATH**/ ?>