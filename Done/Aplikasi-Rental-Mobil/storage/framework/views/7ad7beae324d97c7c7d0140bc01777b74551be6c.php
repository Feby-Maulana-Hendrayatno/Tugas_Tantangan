            ...
            *********************************************************************************************************************************************************** -->
            ...
            <div id="login-page">
                <div class="container">
                    ...
                    <form class="form-login" action="<?php echo e(url('/post_login')); ?>" method="POST">
                        <?php echo e(csrf_field()); ?>

                        <h2 class="form-login-heading">Silahkan Login Dahulu</h2>
            ...
            <script type="text/javascript" src="<?php echo e(url('/theme')); ?>/assets/js/jquery.backstretch.min.js"></script>
            <script>
                $.backstretch("<?php echo e(url('/theme')); ?>/assets/img/login-bg.jpg", {speed: 500});
            </script>


        </body>
        </html>
<?php /**PATH F:\xampp-new\htdocs\Tugas-Tantangan-Komputer\Aplikasi-Rental-Mobil\resources\views/content/auth/login.blade.php ENDPATH**/ ?>