            ...
            *********************************************************************************************************************************************************** -->
            ...
            <div id="login-page">
                <div class="container">
                    ...
                    <form class="form-login" action="{{ url('/post_login') }}" method="POST">
                        {{ csrf_field() }}
            ...
            <script type="text/javascript" src="{{ url('/theme') }}/assets/js/jquery.backstretch.min.js"></script>
            <script>
                $.backstretch("{{ url('/theme') }}/assets/img/login-bg.jpg", {speed: 500});
            </script>
