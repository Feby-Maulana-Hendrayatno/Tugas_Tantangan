...
<body>
    ...
    <?php if (Session::get('logged_in')): ?>
        ...
        <?php if ($user->telepon=='' && $user->alamat==''): ?>
            ...
            <?php echo $__env->make('modal.profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <script>
    ...
    <div class="main-wrapper">
        ...
        <?php echo $__env->make('modal.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('modal.inputpesanan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

    <?php echo $__env->make('modal.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Tugas_Pa_Anis\project-2-new\resources\views/template/first.blade.php ENDPATH**/ ?>