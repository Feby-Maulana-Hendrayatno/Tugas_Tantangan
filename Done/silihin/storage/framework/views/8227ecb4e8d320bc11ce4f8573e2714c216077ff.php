			...
			success: function (response) {
				for (let key in response) {
					if (response.hasOwnProperty(key)) {
						...
						teleponCell.innerHTML = '<a class="btn btn-2primary" href="https://api.whatsapp.com/send?phone='+val['telepon']+'&text=Ada pesan dari customer silihin.co.vu%0A%0ANama : <?php echo e(Session::get("logged_in")["nama_lengkap"]); ?>%0AInvoice : '+val['invoice']+'%0APenyewa : '+val['kendaraan']+'">WhatsApp</a>';
...
<?php echo $__env->make('template/second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tugas_Pa_Anis\project-2-new\resources\views/penyewaan/index.blade.php ENDPATH**/ ?>