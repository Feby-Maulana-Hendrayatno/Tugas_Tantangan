                    ...
                    <div class="navbar-offcanvas navbar-offcanvas-touch navbar-right" id="ct-bootstrap-offcanvas">
                        <ul class="nav navbar-nav ct-list ">
                            ...
                            if (Session::get('logged_in')) {
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" type="button" data-toggle="dropdown"><img src="<?php echo ($user->image=='') ? '/assets/front/images/user.png' : '/storage/' . $user->image; ?>" class="nav-profile-img" alt="<?= $user->nama_lengkap ?>"> <?= $user->nama_lengkap ?>
...
<?php /**PATH D:\Tugas_Pa_Anis\project-2-new\resources\views/layout/nav.blade.php ENDPATH**/ ?>