			...
			<div class="row">
				...
				<center>
					...
					<div class="col-md-6 mt-5 mt-lg-0">
						<?php if(session("belum_ada_akses")): ?>
						<div class="alert alert-danger">
							<?php echo e(session("belum_ada_akses")); ?>

						</div>
						<?php endif; ?>
						<div class="card">
							<div class="card-body">
								<form action="<?php echo e(url('/post_login')); ?>" method="post">
									...
									<div class="text-center">
										...
										<a href="<?php echo e(url('/register_akun')); ?>" style="float: right;">
											Tidak Punya Akun ?
										</a>
									</div>
								</form>
		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row">
				...
				<div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
					<form action="<?php echo e(url('/post_login')); ?>" method="post" role="form" class="php-email-form">
						<?php echo e(csrf_field()); ?>
...
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp-new\htdocs\Tugas-Tantangan-Komputer\Aplikasi-Website-MPM\resources\views/page/user/auth/login.blade.php ENDPATH**/ ?>