<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
  <div class="container">
    ...
    <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
      ...
      <li class="nav-item">
        <a onclick="return confirm('Yakin ? Anda Ingin Logout ?')" class="nav-link" href="<?php echo e(url('/page/bph/logout')); ?>" role="button">
          <i class="fa fa-sign-out"> </i> Logout
        </a>
      </li>
    </ul>
  </div>
</nav><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views/page/layouts/partials/navbar/v_nav_bph.blade.php ENDPATH**/ ?>