            ...
            <tbody>
              ...
              <tr>
                ...
                <form method="POST" action="<?php echo e(url('/page/bph/update_data_absen')); ?>">
                  ...
                  <td class="text-center">
                    <input type="text" class="form-control" name="keterangan" value="<?php echo e($absen->keterangan); ?>" required>
                  </td>
                  <td class="text-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template_bph", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Proyek-MPM-POLINDRA\Contoh\resources\views/page/bph/absen/data_absen_pertanggal.blade.php ENDPATH**/ ?>