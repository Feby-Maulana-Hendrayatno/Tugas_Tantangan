	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="<?php echo e(url('/page/admin/bagian/')); ?>"> Data Bagian </a>
				</li>
				<li class="breadcrumb-item active"> Edit Data Bagian </li>
			</ol>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="<?php echo e(url('/page/admin/bagian/simpan')); ?>">
				<?php echo e(csrf_field()); ?>

				<input type="hidden" name="id_bagian" value="<?php echo e($edit->id_bagian); ?>">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<i class="fa fa-edit"></i> Edit Data Bagian
						</h3>
					</div>
					<div class="card-body">
						<div class="form-group">
							<label for="nama_bagian"> Nama Bagian </label>
							<input type="text" class="form-control" id="nama_bagian" name="nama_bagian" placeholder="Masukkan Nama Bagian" value="<?php echo e($edit->nama_bagian); ?>">
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views//page/admin/bagian/edit_data_bagian.blade.php ENDPATH**/ ?>