...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="<?php echo e(url('/page/admin/prodi/tambah')); ?>">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<?php if(empty($prodi->getJurusan->nama_jurusan)): ?>
										<i><b>Null</b></i>
									<?php else: ?>
										<?php echo e($prodi->getJurusan->nama_jurusan); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views/page/admin/prodi/data_prodi.blade.php ENDPATH**/ ?>