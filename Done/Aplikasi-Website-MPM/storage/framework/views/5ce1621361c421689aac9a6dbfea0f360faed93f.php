...
<section id="portfolio" class="portfolio" style="margin-top: 30px;">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <?php $__currentLoopData = $data_blog_post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <div class="portfolio-img"><img src="<?php echo e(url('/storage/'.$blog->gambar)); ?>" width="400" height="300" alt=""></div>
                <div class="portfolio-info">
                    <h4><?php echo e($blog->judul); ?></h4>
                    <!-- <p>Web</p> -->
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-md-7 mt-5 mt-lg-0">
                    <form action="<?php echo e(url('/kirim_pesan')); ?>" method="post" role="form">
...
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views/page/user/blog.blade.php ENDPATH**/ ?>