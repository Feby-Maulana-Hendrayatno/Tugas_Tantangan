    ...
    <section id="tentang_kami" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                <div class="col-lg-12">
                    <?php $__currentLoopData = $data_tentang_kami; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p style="text-align: justify;">
                        <?php echo $data->body; ?>

                    </p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url('/tentang_kami')); ?>" class="btn btn-primary">
                        Selengkapnya
                    </a>
                </div>
            </div>
...
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp-new\htdocs\Tugas-Tantangan-Komputer\Aplikasi-Website-MPM\resources\views/page/user/dashboard.blade.php ENDPATH**/ ?>