						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									...
									<form method="POST" action="<?php echo e(url('/page/admin/angkatan/non_aktifkan')); ?>">
										<?php echo csrf_field(); ?>
										<input type="hidden" name="id_angkatan" value="<?php echo e($angkatan->id_angkatan); ?>">
										<button type="submit" class="btn btn-danger btn-sm">
											Non - Aktifkan
										</button>
									</form>
									<?php elseif($angkatan->status == "0"): ?>
									<form method="POST" action="<?php echo e(url('/page/admin/angkatan/aktifkan')); ?>">
										<?php echo csrf_field(); ?>
										<input type="hidden" name="id_angkatan" value="<?php echo e($angkatan->id_angkatan); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views//page/admin/angkatan/data_angkatan.blade.php ENDPATH**/ ?>