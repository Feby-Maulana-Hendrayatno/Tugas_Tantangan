		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row">
				...
				<div class="col-md-12 mt-5 mt-lg-0">
					<div class="card">
						<div class="card-body">
							<form action="<?php echo e(url('/tambah')); ?>" method="post">
...
<script type="text/javascript" src="<?php echo e(url('/ckeditor/ckeditor.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views/page/user/aspirasi/form_aspirasi.blade.php ENDPATH**/ ?>