	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
			...
			<div class="col-lg-4 col-md-6 portfolio-item filter-web">
				<div class="portfolio-img"><img src="<?php echo e(url('/storage/'.$berita->gambar)); ?>" class="img-fluid" alt=""></div>
				<div class="portfolio-info">
					<h4><?php echo e($berita->judul); ?></h4>
					<!-- <p>Web</p> -->
					<a href="<?php echo e(url('/template_user/template/')); ?>assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="<?php echo e($berita->judul); ?>">
...
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views//page/user/galeri.blade.php ENDPATH**/ ?>