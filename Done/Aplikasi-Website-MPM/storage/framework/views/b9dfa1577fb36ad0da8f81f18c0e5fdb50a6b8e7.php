  ...
  <div class="row">
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-info">
        ...
        <a href="<?php echo e(url('/page/bph/data_absen')); ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <div class="col-lg-3 col-6">
      <!-- small box -->
      <div class="small-box bg-success">
        ...
        <a href="<?php echo e(url('/page/bph/data_absen_pertanggal')); ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <div class="col-lg-3 col-6">
      <!-- small box -->
      <div class="small-box bg-warning">
        ...
        <a href="<?php echo e(url('/page/bph/kas/data_kas')); ?>" class="small-box-footer">
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-danger">
          ...
          <h3>
            <?php
              ...
              $j_kas_pertanggal = DB::table("tb_kas")
                            ...
                            ->sum("bayar");
            ?>
            Rp. <?php echo e(number_format($j_kas_pertanggal)); ?>
        ...
        <a href="<?php echo e(url('/page/bph/kas/data_kas_pertanggal')); ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template_bph", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Proyek-MPM-POLINDRA\Contoh\resources\views//page/bph/dashboard.blade.php ENDPATH**/ ?>