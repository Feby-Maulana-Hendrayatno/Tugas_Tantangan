					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><?php echo e($anggota->nim); ?></td>
								<td><?php echo e($anggota->nama); ?></td>
								<td class="text-center">
									<?php if(empty($anggota->getKelas->nama_kelas)): ?>
									<i><b>NULL</b></i>
									<?php else: ?>
									<?php echo e($anggota->getKelas->nama_kelas); ?>

									<?php endif; ?>
								</td>
								<td class="text-center">
									<button onclick="editAnggota(<?php echo e($anggota->nim); ?>)" type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-default-edit">
										<i class="fa fa-edit"></i> Edit
									</button>
									<form onsubmit="return false" id="form" class="d-inline">
										<?php echo e(csrf_field()); ?>

										<button id="btn-hapus" class="btn btn-danger btn-sm" onclick="hapus(<?php echo e($anggota->nim); ?>)">
											<i class="fa fa-trash-o"></i> Hapus
										</button>
										<a href="<?php echo e(url('/page/admin/anggota')); ?>/<?php echo e($anggota->id); ?>/detail" class="btn btn-success btn-sm">
...
<div class="modal fade" id="modal-default">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="quickForm" method="POST" action="<?php echo e(url('/page/admin/anggota/tambah')); ?>" enctype="multipart/form-data">
				<?php echo e(csrf_field()); ?>
...
<div class="modal fade" id="modal-default-edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="quickForm2" method="POST" action="<?php echo e(url('/page/admin/anggota/simpan')); ?>">
				<?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
	function editAnggota(nim) {
		$.ajax({
			url : "<?php echo e(url('/page/admin/anggota/edit')); ?>",
			type : "GET",
			data : { nim : nim },
...
<script type="text/javascript">
	function hapus(nim)
	{
		...
		.then((willDelete) => {
			if (willDelete) {
				$.ajax({
					url : "<?php echo e(url('/page/admin/anggota/hapus')); ?>/" + nim,
					type : "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("page.layouts.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Proyek-Terbaru-MPM\Contoh\resources\views//page/admin/anggota/data_anggota.blade.php ENDPATH**/ ?>