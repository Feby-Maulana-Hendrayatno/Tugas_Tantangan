  ...
  <section id="tentang_kami" class="about">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row content">
        <div class="col-lg-4">
          <img src="<?php echo e(url('/gambar/MPM .jpg')); ?>" width="300px">
        </div>
...
<?php echo $__env->make("page.layouts.template_user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Proyek-MPM-POLINDRA\Contoh\resources\views/page/user/tentang_kami.blade.php ENDPATH**/ ?>