	...
	<div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item">
					<a href="{{ url('/page/admin/bagian/') }}"> Data Bagian </a>
				</li>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-4">
			<form id="quickForm" method="POST" action="{{ url('/page/admin/bagian/simpan') }}">
				{{ csrf_field() }}
				<input type="hidden" name="id_bagian" value="{{ $edit->id_bagian }}">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama_bagian" name="nama_bagian" placeholder="Masukkan Nama Bagian" value="{{ $edit->nama_bagian }}">
						</div>
					</div>
